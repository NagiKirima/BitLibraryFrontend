    ...
    <div class="container mt-3">
        <div class="card">
            <div class="card-body">
                ...
                <p><strong>ID Author:</strong> {{ id_author }}</p>
                <p><strong>Author Name:</strong> {{ author.author_name }}</p>
            </div>
        </div>
...
export default defineComponent({
    ...
    methods: {
        async fetchAuthor(){
            await AuthorsService.getAuthorById(this.id_author)
            .then(response => {
        ...
        async fetchBooks(){
            await BookService.getBookByAuthor(
                this.id_author,
    ...
    watch: {
        ...
        '$route.params': {
            async handler(newParams, oldParams) {
                this.id_author = newParams.id_author;
